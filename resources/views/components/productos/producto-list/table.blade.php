            ...
            <div class="p-5 sm:p-6 dark:border-gray-800">
                ...
                <div
                    ...
                    <div class="max-w-full overflow-x-auto custom-scrollbar">
                        <table id="tProductos" class="min-w-full">
                            <!-- table header start -->
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th class="hidden px-6 py-3 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <p
                                                class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">
                                                Fecha creación
                            ...
                            <!-- table body start -->
                            <tbody id="tbProductos" class="divide-y divide-gray-100 dark:divide-gray-800">
                            </tbody>
                            <!-- table body end -->
                        </table>
                    </div>
