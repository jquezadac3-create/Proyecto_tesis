...
@section('assets')
    @vite(['resources/js/sorteos/generarBoletos.js', 'resources/css/custom-choices.css'])
...
@section('breadcrumb')
    ...
    <div x-show="selected === 'sorteo.boletos'">
