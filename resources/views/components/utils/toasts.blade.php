...
<div x-data="{
    ...
    // List can be use to show multiple errors
    addNotification({ variant = 'info', sender = null, title = null, message = null, list = null, sound }) {
        const id = Date.now()
        const notification = { id, variant, sender, title, message, list }
        ...
        if (sound) {
            ...
            const soundEffect = variant === 'error' ? 'https://res.cloudinary.com/diobbkbe4/video/upload/v1759264691/ttsError-Lupe-Voice_xj2ald.mp3' : 'https://res.cloudinary.com/diobbkbe4/video/upload/v1759263784/ttsThx-Lupe-Voice_g9jb8s.mp3'
    ...
    @notify.document="addNotification({
            variant: $event.detail.variant,
            sender: $event.detail.sender,
            title: $event.detail.title,
            message: $event.detail.message,
            list: $event.detail.list,
            sound: $event.detail.sound,
        })">

    <div x-on:mouseenter="$dispatch('pause-auto-dismiss')" x-on:mouseleave="$dispatch('resume-auto-dismiss')"
        class="group pointer-events-none fixed inset-x-8 top-0 z-[99999] flex max-w-full flex-col gap-2 bg-transparent px-6 py-6 md:top-0 md:left-[unset] md:right-0 md:bottom-[unset] md:max-w-sm">
                    ...
                    <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <template x-if="notification.list && Array.isArray(notification.list)">
                                    <ul
                                        class="mt-2 list-inside list-disc pl-2 text-xs font-medium text-info sm:text-sm">
                                        <template x-for="lItem in notification.list" :key="lItem">
                                            <li x-text="lItem"></li>
                                        </template>
                                    </ul>
                                </template>
                    ...
                    <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <template x-if="notification.list && Array.isArray(notification.list)">
                                    <ul
                                        class="mt-2 list-inside list-disc pl-2 text-xs font-medium text-success sm:text-sm">
                                        <template x-for="lItem in notification.list" :key="lItem">
                                            <li x-text="lItem"></li>
                                        </template>
                                    </ul>
                    ...
                    <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <template x-if="notification.list && Array.isArray(notification.list)">
                                    <ul
                                        class="mt-2 list-inside list-disc pl-2 text-xs font-medium text-warning sm:text-sm">
                                        <template x-for="lItem in notification.list" :key="lItem">
                                            <li x-text="lItem"></li>
                                        </template>
                                    </ul>
                    ...
                    <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <template x-if="notification.list && Array.isArray(notification.list)">
                                    <ul
                                        class="mt-2 list-inside list-disc pl-2 text-xs font-medium text-danger sm:text-sm">
                                        <template x-for="lItem in notification.list" :key="lItem">
                                            <li x-text="lItem"></li>
                                        </template>
                                    </ul>
